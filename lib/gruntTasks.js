    ...
    fs.readFile(filePath, 'binary', function(err, data) {
        ...
        while ((m = re.exec(str)) != null) {
            ...
            if (slot.fragments[fragmentName]) {
                ...
                !usageMap.fragment[fragmentName] && (usageMap.fragment[fragmentName] = { page:[], fragment:[] });

                // Add relation beteewn fragment and page if it does not exists
                usageMap.fragment[fragmentName].page.indexOf(url) < 0 && (usageMap.fragment[fragmentName].page.push(url));
            };
        }
